...
class Kernels2CHeaders(object):
    ...
    def read_file_lines(file_path):
        # Read text in a deterministic and lossless way.
        # Never use replacement here to avoid silently changing kernel source.
        try:
            with open(file_path, encoding='utf-8') as f:
                return f.readlines()
        except UnicodeDecodeError:
            pref_enc = locale.getpreferredencoding(False) or 'utf-8'
            with open(file_path, encoding=pref_enc) as f:
                return f.readlines()
    ...
    def find_and_set_batch_headers(self):
        ...
        for h in batch_headers_list:
            ...
            content = self.read_file_lines(header_file)
            deps[h] = {h}
            for line in content:
    ...
    def convert(self):
        ...
        with open(out_file_name_prim_db, 'w', encoding='utf-8') as out_file:
            out_file.write(res)
        ...
        with open(out_file_name_batch_headers, 'w', encoding='utf-8') as out_file:
